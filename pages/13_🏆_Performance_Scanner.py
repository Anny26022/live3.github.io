...
# --- Instrument Type Selection (only 'stock' enabled, others disabled with banner) ---
instrument_options = ["stock", "fund", "etf", "reit", "all"]
selected_instrument = st.selectbox(
    "Select Instrument Type:",
    options=instrument_options,
    index=0,
    format_func=lambda x: f"{x} (coming soon)" if x != "stock" else x,
    key="instrument_type_perf"
)

if selected_instrument != "stock":
    st.markdown("""
    <div style='display:flex;align-items:center;justify-content:center;margin:1.5em 0;'>
      <svg width='34' height='34' fill='none' xmlns='http://www.w3.org/2000/svg' style='margin-right:10px;'><rect width='34' height='34' rx='8' fill='#facc15'/><path d='M11 17h12M17 11v12' stroke='#b45309' stroke-width='2.2' stroke-linecap='round'/><circle cx='17' cy='17' r='15' stroke='#fde68a' stroke-width='2.2'/></svg>
      <span style='font-size:1.25rem;font-weight:600;color:#b45309;'>Development in progress: Only 'stock' is enabled</span>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
